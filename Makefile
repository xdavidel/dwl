...
dwl.o: dwl.c config.mk config.h client.h xdg-shell-protocol.h wlr-layer-shell-unstable-v1-protocol.h dwl-ipc-unstable-v2-protocol.o wlr-output-power-management-unstable-v1-protocol.h
...
install: dwl
	install -Dm 755 dwl $(DESTDIR)$(PREFIX)/bin/dwl
	install -Dm 644 dwl.1 $(DESTDIR)$(MANDIR)/man1/dwl.1
