...
static const Rule rules[] = {
	...
	{ "image-roll",  NULL,           0,            0,           -1,      0  },
	{ "file-roller", NULL,           0,            0,           -1,      0  },
	{ "mpv",         NULL,           0,            0,           -1,      0  },
	{ NULL,          "Media viewer", 0,            1,           -1,      0  },
...
static const char *menucmd[] = { "bemenu-run", "-H", "30", "--fn", "mono 16", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    Key_XF86ScrollUp,         incnmaster,       {.i = +1} },
	{ MODKEY,                    Key_XF86ScrollDown,       incnmaster,       {.i = -1} },
	...
	{ MODKEY,                    Key_i,                    spawn,            SHCMD("$TERMINAL -e htop") },
	...
	{ MODKEY,                    Key_x,                    spawn,            SHCMD("swaylock -c 010101") },
